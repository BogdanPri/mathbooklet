...
\begin{tikzpicture}
    ...
    \addplot+[blue, very thick, mark=none, domain=-5.5:5.5] plot {.5*x+1};
    \addlegendentry{$y=\frac{1}{2}x+1$}
    \addplot+[red, very thick, mark=none, domain=-5.5:5.5] plot {1.5*x-1};
    \addlegendentry{$y=\frac{3}{2}x-1$}
    \draw[black, fill=black] (2,2) circle [radius=.5mm]
        node[below right]{$(2,2)$};
    \end{axis}
\end{tikzpicture}
\end{document}
